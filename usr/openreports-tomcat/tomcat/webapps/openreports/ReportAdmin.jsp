...
<div align="center">
    ...
    <tr> 
	    ...
	    <tr class="even">   
	    <td class="img-ds">             
         	<a href="AddDSDashboard.jsp"><s:text name="Data Source Sync"/></a><br/>
         	<s:text name="Sync Datasources - Oracle Only."/>         	
       	</td>
       	</tr>
       	</s:if> 
		<s:if test="#session.user.dataSourceAdmin">    
	    <tr class="even">   
	    <td class="img-dssss">             
         	<a href="/openreports/reportDetail.action?reportId=92"><s:text name="Import Queue"/></a><br/>
         	<s:text name="Import All SA Data."/>         	
       	</td>
       	</tr>
       	</s:if> 
       	...
       	<td class="img-report" > 		
			...
			<s:text name="Manage Reports and Templates."/>            
        </td>
        </tr> 
        </s:if>  
		<s:if test="#session.user.reportAdmin">
       	<tr class="even">
       	<td class="img-reportt" > 		
			<a href="/openreports/ExecuteReportTest.jsp"><s:text name="Report Tester"/></a><br/>
			<s:text name="Test Reports Here."/>            
        </td>
        </tr> 
        </s:if> 
    	...
    	<tr class="even">  
 		<td class="img-group">             
         	...
         	<s:text name="Add, Delete  or Modify Groups."/>         
        </td>
        </tr>
        </s:if>
        ...
        <td class="img-user">       	
         	...
         	<s:text name="Add, Delete  or Modify Users."/>            
        </td>         
        </tr>
        </s:if>
        ...
        <td class="img-schedule">          
          <a class="icon" href="/openreports/SchedulerAdmin.jsp"><s:text name="link.admin.scheduler"/></a><br/>   
		...
		<s:if test="#session.user.rootAdmin">  
  		<tr class="even">    
        <td class="img-quartz">          
          <a class="icon" href="/openreports/SchedulerDashboard.jsp"><s:text name="Scheduler Dashboard"/></a><br/>   
          <s:text name="Scheduler Dashboard."/>        
        </td> 
        </tr>
        </s:if>
        <tr class="even">	      
        <td class="img-queryreport">
          ...
          <s:text name="Search for reporter tags."/>
        </td> 
        </tr>
        <s:if test="#session.user.rootAdmin"> 
        <tr class="even">
 	...
 	<s:if test="#session.user.logViewer">  
        <tr class="even">  
        <td class="img-stats">        
         	<a href="AnalyzeReportLogs.jsp"><s:text name="Reporter ROI"/></a><br/>
         	<s:text name="Reporter Statistics."/>       
        </td>
        </tr>
        </s:if>     
