#!/usr/bin/perl
    ...
    #print "$host_name";
    @out = `sudo grep -B6 -i error /usr/AIR/tmp/$log_name 2<&1`;
    $err = $?;
...
<div id="header"></div>
	...
	<section class="intro" id="zen-intro">
		...
		<div class="summary" id="zen-summary" role="article">
			<p> The list below is the reult of the last AIR data load logs.</p>
		</div>
	</section>
<hr>
...
<table id="t01">
<tr><th><font face="Georgia" size="2">Log Details for log file: $log_name</font></th>

HTML


	foreach $iou (@out){
			print("<tr><td><font face='Georgia' size='2'>$iou</font></td></tr>");
	}
